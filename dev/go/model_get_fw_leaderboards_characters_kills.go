...
type GetFwLeaderboardsCharactersKills struct {
	...
	ActiveTotal []GetFwLeaderboardsCharactersActiveTotal `json:"active_total,omitempty"`
	/*
	 Top 100 ranking of pilots by kills in the past week */
	LastWeek []GetFwLeaderboardsCharactersLastWeek `json:"last_week,omitempty"`
	/*
	 Top 100 ranking of pilots by kills in the past day */
	Yesterday []GetFwLeaderboardsCharactersYesterday `json:"yesterday,omitempty"`
}
